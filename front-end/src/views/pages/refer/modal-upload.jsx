  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth='lg'>
      ...
      >
        ...
        <span className='pt-2 pr-2' style={{ fontSize: '0.875rem', color: 'gray' }}>
          Refer-ID: {dataRefer.id}
        </span>
      </Box>
                ...
                <div {...getRootProps({ className: 'dropzone' })}>
                  ...
                  <div className='flex items-center flex-col'>
                    ...
                    <Typography className='text-error'>
                      หากเป็น .pdf อัปโหลดได้ครั้งละ 1 ไฟล์และขนาดไม่เกิน 5 MB
                    </Typography>
                  </div>
                </div>
                {files.length ? (
          ...
          <>
            <div className='buttons pt-3'>
              <Button
                ...
                variant='outlined'
                onClick={() => {
                  handleRemoveAllFiles(), handleClose()
                }}
              >
                Cancel
              </Button>
