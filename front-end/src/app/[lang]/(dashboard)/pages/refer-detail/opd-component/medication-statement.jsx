...
const MedicationStatement = ({ data }) => {
  ...
  return (
    <Grid item xs={12} md={12}>
      <TableContainer component={Paper} className='overflow-y-auto max-h-[96vh]'>
          ...
          <TableBody>
            ...
            {data.map((rowData, rowIndex) => (
              <TableRow key={rowIndex}>
                {fields.map((field, index) => (
                  <TableCell key={index}  className='whitespace-nowrap'  align={field.value === 'RXO_TOTAL_USAGE' ? 'center' : 'left'}>
