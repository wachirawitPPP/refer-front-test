...
export default function CreateProfile({ formValues, setFormValues, isViewOnly }) {
  ...
  const addFormFields = () => {
    ...
    console.log("test", currentValuesSelect)
  }
        ...
        <Grid item xs={12} md={6} className='space-y-3'>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={2}>
              {currentValuesSelect.diagnosisList ? (
                <Grid item xs={12} md={3}>
                  <Button fullWidth variant='contained' onClick={addFormFields}>
                  ...
                  formValuesSelect.map((element, index) => (
                    <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                      <TableCell component='th' scope='row'>
                       {element.diagnostic_id || element.diagnosisList.id}
                      </TableCell>
                      {isMd ? (
                        <TableCell>
                          {element.diagnostic_th || element.diagnosisList.diagnostics_th} : {element.diagnostic_en || element.diagnosisList.diagnostics_en}
                        </TableCell>
                      ) : (
                        <TableCell style={{ wordWrap: 'break-word', whiteSpace: 'normal' }}>
                          {element.diagnostic_th || element.diagnosisList.diagnostics_th} : <br></br> ({element.diagnostic_en || element.diagnosisList.diagnostics_en}) 
                        </TableCell>
                      )}
                          ...
                          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                            <Tooltip title='Remove'>
                              <i
                                ...
                                className='tabler-trash text-[22px]'
                              />
                            </Tooltip>
                          </div>
                        </TableCell>
